...
func (q *Queries) ToggleChirpRed(ctx context.Context, arg ToggleChirpRedParams) (User, error) {
	row := q.db.QueryRowContext(ctx, toggleChirpRed, arg.ID, arg.IsChirpyRed)
	var i User
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
